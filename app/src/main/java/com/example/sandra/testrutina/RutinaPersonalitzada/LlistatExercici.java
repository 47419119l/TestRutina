...
public class LlistatExercici extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_llistat_exercici);
        ...
        afeguirExercici = (FloatingActionButton) findViewById(R.id.returnform);
